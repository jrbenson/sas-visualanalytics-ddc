...
//
export function validateRoles(resultData, expectedTypes, optionalTypes) {
...
export function initializeSelections(resultData) {
...
export function convertDateColumns(resultData) {
	if (!resultData)
		return;
...
export function getVAParameters(resultData) {
	var parameters = {}
